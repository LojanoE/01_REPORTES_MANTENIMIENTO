...
def migrate(do_clean: bool = False, dry_run: bool = False):
    ...
    for row_idx in range(7, ws_in.max_row + 1):
        ...
        transactions_in.append({
            ...
            "num_vale_egreso": clean(ws_in.cell(row_idx, 17).value),
            "ruta_td": clean(ws_in.cell(row_idx, 12).value),
            "td": clean(ws_in.cell(row_idx, 13).value),
            "num_item_td": clean(ws_in.cell(row_idx, 15).value),
            "num_solicitud_nc": clean(ws_in.cell(row_idx, 16).value),
            "ruta": clean(ws_in.cell(row_idx, 19).value),
